...
public class MiiLoader
{
    ...
    public static async Task<IImage> GetMiiImageAsync(string base64MiiData)
    {
        using var formData = new MultipartFormDataContent
        {
            { new ByteArrayContent(Convert.FromBase64String(base64MiiData)), "data", "mii.dat" },
            { new StringContent("wii"), "platform" }
        };
        ...
        return UIProvider.ImageFactory.NewImage(miiImageUrl);
    }
